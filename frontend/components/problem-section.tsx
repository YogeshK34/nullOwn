      ...
      <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-center justify-center px-6 md:px-12 lg:px-16">
        <div className="space-y-8 text-center flex flex-col items-center">
          ...
          <h2 className="text-balance text-5xl font-normal tracking-tight text-white md:text-6xl lg:text-5xl">
            {"Every Position Is Public".split(" ").map((word, i) => (
              <motion.span
                key={i}
          ...
          <p className="text-balance text-lg leading-relaxed text-gray-300 md:text-xl">
            KYC confirms who you are at onboarding, then does nothing about what the world can see
            afterwards. Every holding and every transfer stays permanently readable, so competitors
            can track an institution&apos;s real-time positions from a block explorer. Pledge that
            same token as DeFi collateral and the exposure compounds — one identity, linked across
            every protocol it touches. Proving you own something should not require showing
            everything you own.
          </p>
